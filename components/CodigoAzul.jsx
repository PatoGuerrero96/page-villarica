...
<div className="relative w-full h-[40vh] md:h-[50vh] lg:h-[110vh] xl:h-[150vh]  overflow-hidden bg-azul z-10">
  {/* svg amarillo */}
    <svg
className="
  absolute 

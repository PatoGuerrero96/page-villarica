...
const FichaClinica = () => {
  return (
<div className="relative w-full h-[45vh] md:h-[50vh] lg:h-[55vh] overflow-hidden bg-morado py-5 md:py-24 z-10">
  ...
  <div className="relative px-4 md:px-8 lg:px-16 text-white flex flex-col gap-6 w-full h-full">
    <h2 className="text-4xl md:text-5xl font-bold text-center uppercase border-2 text-white rounded-full px-6 py-2 inline-block mx-auto">
      Código Azul
    </h2>

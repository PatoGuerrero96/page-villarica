...
const AccidenteFluidos = () => {
  return (
<div className="relative w-full h-[40vh] md:h-[50vh] lg:h-[110vh] xl:h-[110vh]  overflow-hidden bg-naranjo z-10">
  {/* svg amarillo */}
    <svg
className="
  absolute 
...
>
  ...
  >
    03
        ...
        <p className="text-md md:text-4xl lg:text-4xl xl:text-5xl  text-left mb-2 ">
        Si la ropa se 03 <strong>contamina, retírala y dúchate.</strong>
        </p>
